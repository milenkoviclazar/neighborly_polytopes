/*
 * Used to check the matrices with added rows.
 */
...
int main(int argc, char *argv[]) {
    ...
    while (getNextPolytope(polytopeDescription)) {
        ...
        if ((id == -1) || (polytopeIdx % mpiNodeCount == id)) {
            ...
            cout << "\\\\\\\\" << endl;
            if (startSearch(polytopeDescription, r + 1, c)) {
//                cout << "f" << endl;
            } else if (startSearch(polytopeDescription, r + 2, c)) {
